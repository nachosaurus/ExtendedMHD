...
\begin{align*}
    ...
    = \beta^2\,\frac{m_e}{Z m_i},
\end{align*}
where $Z$ denotes the number of ion carriers. Hence the electron-inertia term is suppressed relative to the square of the Hall term strength by the electron-to-ion mass and charge ratio. For a hydrogen plasma, $Z=1$ and $m_i/m_e \approx 1836$. If the characteristic length is chosen to be $L_0=\delta_i$, then $\beta = 1$ and $\alpha \approx 1/1836$.

\rf{This seems to suggest that the electron inertia term effects are only resolved if the mesh spacing is smaller than the electron skin depth (very small!!)}
